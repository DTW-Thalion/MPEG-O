 ...
 *   Each TTIOHDF5File owns a pthread_rwlock_t that serialises access from
 *   TTIOHDF5Group and TTIOHDF5Dataset instances derived from it. Readers do
...
/**
 * Open a remote .tio file hosted on S3 (or any S3-compatible endpoint
 ...
 *  NO means +openS3URL: will fail with TTIOErrorFileOpen and callers
...
/** Walks the retainer chain to the owning file. TTIOHDF5File returns self. */
