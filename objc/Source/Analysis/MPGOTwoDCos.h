#ifndef MPGO_TWO_D_COS_H
#define MPGO_TWO_D_COS_H

#import <Foundation/Foundation.h>

@class MPGOAxisDescriptor;
@class MPGOTwoDimensionalCorrelationSpectrum;
 ...
 *   Python: mpeg_o.analysis.two_d_cos
 *   Java:   com.dtwthalion.mpgo.analysis.TwoDCos
 */
@interface MPGOTwoDCos : NSObject
