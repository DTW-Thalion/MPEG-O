...
@implementation MPGOInstrumentConfig
...
{
    MPGOHDF5Group *g = [parent createGroupNamed:@"instrument_config" error:error];
    if (!g) return NO;
...
{
    MPGOHDF5Group *g = [parent openGroupNamed:@"instrument_config" error:error];
    if (!g) return nil;
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[MPGOInstrumentConfig class]]) return NO;
    MPGOInstrumentConfig *o = (MPGOInstrumentConfig *)other;
