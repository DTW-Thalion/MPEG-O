/*
 * MPGOImzMLWriter — imzML + .ibd exporter (v0.9+).
 *
 * Reverses MPGOImzMLReader: takes a list of pixel spectra + grid
 ...
 * ImzMLParser and round-trips through MPGOImzMLReader bit-identically.
 *
 * SPDX-License-Identifier: Apache-2.0
 *
 * Cross-language equivalents
 * --------------------------
 * Python: mpeg_o.exporters.imzml  ·
 * Java:   com.dtwthalion.mpgo.exporters.ImzMLWriter
 *
 * @since 0.9
 */
#import <Foundation/Foundation.h>

@class MPGOImzMLPixelSpectrum;
@class MPGOImzMLImport;

NS_ASSUME_NONNULL_BEGIN

@interface MPGOImzMLWriteResult : NSObject
...
@interface MPGOImzMLWriter : NSObject

/**
 * Write an imzML + .ibd pair.
 *
 * @param pixels       Array of MPGOImzMLPixelSpectrum objects.
...
/** Round-trip helper: re-emit an MPGOImzMLImport to disk. */
