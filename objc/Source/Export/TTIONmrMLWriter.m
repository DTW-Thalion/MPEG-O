...
@implementation TTIONmrMLWriter
                      ...
                      error:(NSError **)error
{
    ...
    emit(out, @"    <software id=\"ttio\" version=\"0.9.0\""
    ...
    if (fid) {
        NSString *fidB64 = [TTIOBase64 encodeData:fid.buffer zlibDeflate:NO];
        emit(out, [NSString stringWithFormat:
    ...
    NSString *xyB64 = [TTIOBase64 encodeData:xy zlibDeflate:NO];
