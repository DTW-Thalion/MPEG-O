#import "MPGORamanImage.h"
#import "HDF5/MPGOHDF5File.h"
#import "HDF5/MPGOHDF5Group.h"
#import "HDF5/MPGOHDF5Errors.h"
#import <hdf5.h>

#define MPGO_RAMAN_IMAGE_GROUP "raman_image_cube"

@implementation MPGORamanImage
...
static void readCoreMeta(hid_t g, mpgo_img_core_t *out)
{
    int64_t v;
    hid_t a;
...
#pragma mark - MPGOSpectralDataset hooks
...
- (BOOL)readAdditionalStudyContent:(MPGOHDF5Group *)studyGroup
                             error:(NSError **)error
{
    if (![studyGroup hasChildNamed:@MPGO_RAMAN_IMAGE_GROUP]) return YES;
    hid_t g = H5Gopen2(studyGroup.groupId, MPGO_RAMAN_IMAGE_GROUP, H5P_DEFAULT);
    if (g < 0) return YES;

    mpgo_img_core_t meta; memset(&meta, 0, sizeof(meta));
    readCoreMeta(g, &meta);
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[MPGORamanImage class]]) return NO;
    MPGORamanImage *o = (MPGORamanImage *)other;
