#import "MPGOIsolationWindow.h"

@implementation MPGOIsolationWindow
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[MPGOIsolationWindow class]]) return NO;
    MPGOIsolationWindow *w = (MPGOIsolationWindow *)other;
...
- (NSString *)description
{
    return [NSString stringWithFormat:
        @"<MPGOIsolationWindow target=%g [-%g, +%g]>",
