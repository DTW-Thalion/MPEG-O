...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    TTIOValueRange *range = [coder decodeObjectForKey:@"valueRange"];
...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[TTIOAxisDescriptor class]]) return NO;
    TTIOAxisDescriptor *a = (TTIOAxisDescriptor *)other;
