#ifndef MPGO_ISOLATION_WINDOW_H
#define MPGO_ISOLATION_WINDOW_H
 ...
 *   Python: mpeg_o.isolation_window.IsolationWindow
 *   Java:   com.dtwthalion.mpgo.IsolationWindow
 */
@interface MPGOIsolationWindow : NSObject <NSCoding, NSCopying>
