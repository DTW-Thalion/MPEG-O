...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[TTIOValueRange class]]) return NO;
    TTIOValueRange *r = (TTIOValueRange *)other;
...
{
    return [NSString stringWithFormat:@"<TTIOValueRange [%g, %g]>", _minimum, _maximum];
}
