#ifndef MPGO_JCAMP_DX_DECODE_H
#define MPGO_JCAMP_DX_DECODE_H
 ...
 * directly by MPGOJcampDxReader; this class is consulted only when
 * `hasCompression:` reports a compression sentinel.
 *
 * Cross-language equivalents:
 *   Java:   com.dtwthalion.mpgo.importers.JcampDxDecode
 *   Python: mpeg_o.importers._jcamp_decode
 */
@interface MPGOJcampDxDecode : NSObject
