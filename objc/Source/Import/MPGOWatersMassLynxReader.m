...
#import "MPGOWatersMassLynxReader.h"
#import "MPGOMzMLReader.h"
#import <stdlib.h>
#import <unistd.h>

static NSString *const kMassLynxErrorDomain = @"MPGOWatersMassLynxReader";
...
@implementation MPGOWatersMassLynxReader
                                           ...
                                           error:(NSError **)error
{
    ...
    NSString *tmpDir = [NSTemporaryDirectory() stringByAppendingPathComponent:
        [NSString stringWithFormat:@"mpgo_masslynx_%d_%ld",
    ...
    MPGOSpectralDataset *ds = [MPGOMzMLReader readFromFilePath:mzmlPath error:error];
    [fm removeItemAtPath:tmpDir error:NULL];
    return ds;
}
