 ...
 */
#import "MPGOBrukerTDFReader.h"
#import "HDF5/MPGOHDF5Errors.h"
#import <sqlite3.h>

@interface MPGOBrukerTDFMetadata ()
...
@implementation MPGOBrukerTDFMetadata
...
@implementation MPGOBrukerTDFReader
                                                   ...
                                                   error:(NSError **)error
{
    ...
    return [[MPGOBrukerTDFMetadata alloc]
...
{
    NSString *env = [[NSProcessInfo processInfo] environment][@"MPGO_PYTHON"];
                ...
                error:(NSError **)error
{
    ...
    NSError *mdErr = nil;
    MPGOBrukerTDFMetadata *md = [self readMetadataAtPath:dDir error:&mdErr];
    if (!md) {
    ...
    task.arguments = @[
        @"-m", @"mpeg_o.importers.bruker_tdf_cli",
        @"--input", dDir,
        @"--output", output,
    ];
