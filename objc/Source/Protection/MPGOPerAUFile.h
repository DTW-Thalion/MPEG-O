/*
 * MPGOPerAUFile — v1.0 file-level per-AU encryption orchestrator.
 *
 * Reads plaintext <channel>_values datasets from an MPEG-O file,
 * encrypts each spectrum independently with MPGOPerAUEncryption,
 * and rewrites the file's signal_channels groups with the
 * <channel>_segments compound layout from docs/format-spec.md §9.1.
 * Routes through the MPGOStorageProvider / MPGOStorageGroup
 ...
 *   Python: mpeg_o.encryption_per_au.encrypt_per_au/decrypt_per_au
 *   Java:   com.dtwthalion.mpgo.protection.PerAUFile
 *
 * SPDX-License-Identifier: LGPL-3.0-or-later
 */
#ifndef MPGO_PER_AU_FILE_H
#define MPGO_PER_AU_FILE_H

#import <Foundation/Foundation.h>

NS_ASSUME_NONNULL_BEGIN

@interface MPGOPerAUFile : NSObject
 ...
 *  MPGOProviderRegistry); passing "hdf5" forces the HDF5 provider.
 */
 ...
 *  ``__au_headers__`` as an NSArray<MPGOAUHeaderPlaintext *>.
 */
