/*
 * MPGOPostQuantumCrypto.h — ML-KEM-1024 + ML-DSA-87 primitives
 * (v0.8 M49).
 *
 * Thin wrapper over liboqs (Open Quantum Safe) giving the rest of
 * libMPGO a stable surface for FIPS 203 (ML-KEM-1024) key
 ...
 * entry points in this class return NO with MPGOErrorPQCUnavailable
 ...
 *   Python: mpeg_o.pqc
 *   Java:   com.dtwthalion.mpgo.protection.PostQuantumCrypto
 *
 * SPDX-License-Identifier: LGPL-3.0-or-later
 */
#ifndef MPGO_POST_QUANTUM_CRYPTO_H
#define MPGO_POST_QUANTUM_CRYPTO_H
...
@interface MPGOPQCKeyPair : NSObject
 ...
 *  AES-256 KEK). */
@interface MPGOPQCKemEncapResult : NSObject
...
#endif /* MPGO_POST_QUANTUM_CRYPTO_H */
