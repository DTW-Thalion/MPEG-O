/*
 * MPEG-O Objective-C Implementation
 * Copyright (C) 2026 DTW-Thalion
 * SPDX-License-Identifier: LGPL-3.0-or-later
 */
#ifndef MPGO_FEATURE_H
#define MPGO_FEATURE_H
 ...
 *
 * Sits between {@link MPGOIdentification} (spectrum-level) and
 * {@link MPGOQuantification} (entity-level): the row-level record
 ...
 *   Python: mpeg_o.feature.Feature
 *   Java:   com.dtwthalion.mpgo.Feature
 */
@interface MPGOFeature : NSObject <NSCopying>
