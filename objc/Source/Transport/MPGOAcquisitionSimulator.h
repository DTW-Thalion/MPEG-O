/*
 * MPGOAcquisitionSimulator — v0.10 M69.
 *
 * Synthetic LC-MS acquisition simulator. Produces transport packets
 * into an MPGOTransportWriter. Deterministic under a fixed seed;
 ...
 */
#ifndef MPGO_ACQUISITION_SIMULATOR_H
#define MPGO_ACQUISITION_SIMULATOR_H
...
@interface MPGOAcquisitionSimulator : NSObject
