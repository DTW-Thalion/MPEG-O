/*
 * MPGOTransportServer — v0.10 M68.5 parity backfill.
 *
 * WebSocket transport server built on libwebsockets. Serves an
 * MPGOSpectralDataset to connecting clients with full server-side
 * filtering (ms_level, rt range, precursor m/z range, polarity,
 * dataset_id, max_au cap). Wire protocol identical to Python
 * mpeg_o.transport.server.TransportServer and Java
 * com.dtwthalion.mpgo.transport.TransportServer.
 *
 * SPDX-License-Identifier: LGPL-3.0-or-later
 */
#ifndef MPGO_TRANSPORT_SERVER_H
#define MPGO_TRANSPORT_SERVER_H

#import <Foundation/Foundation.h>

NS_ASSUME_NONNULL_BEGIN

@interface MPGOTransportServer : NSObject
