 ...
 * and Java ``com.dtwthalion.tio.tools.TransportServerCli``.
 *
...
int main(int argc, const char **argv)
{
    @autoreleasepool {
        if (argc < 2) {
            fprintf(stderr, "usage: TtioTransportServer <path.tio> "
        ...
        TTIOTransportServer *srv =
            [[TTIOTransportServer alloc] initWithDatasetPath:path host:host port:port];
        NSError *err = nil;
