                                ...
                                NSString **outIbdUUIDHex)
{
    ...
    NSString *imzml = [NSString stringWithFormat:
        ...
        @"    <cvParam cvRef=\"IMS\" accession=\"IMS:1000042\" name=\"max count of pixels x\" value=\"%ld\"/>\n"
        @"    <cvParam cvRef=\"IMS\" accession=\"IMS:1000043\" name=\"max count of pixels y\" value=\"%ld\"/>\n"
