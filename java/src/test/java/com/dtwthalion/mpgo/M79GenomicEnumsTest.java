...
import com.dtwthalion.mpgo.providers.MemoryProvider;
import com.dtwthalion.mpgo.providers.SqliteProvider;
...
import com.dtwthalion.mpgo.providers.ZarrProvider;
import com.dtwthalion.mpgo.transport.AccessUnit;
...
public class M79GenomicEnumsTest {
    ...
    public void uint8RoundTripSqlite() {
        String path = tempDir.resolve("m79_uint8.mpgo.sqlite").toString();
        byte[] expected = uint8Sample();
