 ...
 *  via imageForKind(RAMAN) (the realistic tio-browser code path) and writes the bytes to stdout in
...
public final class RamanImageXLangReader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (SpectralDataset ds = SpectralDataset.open(args[0])) {
            RamanImage img = (RamanImage) ds.imageForKind(Enums.ImageKind.RAMAN);
            if (img == null) {
