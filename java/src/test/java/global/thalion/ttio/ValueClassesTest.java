...
import global.thalion.ttio.Enums.ByteOrder;
...
class ValueClassesTest {
    ...
    void signalArrayIsCvAnnotatable() {
        ...
        assertTrue(sa instanceof global.thalion.ttio.protocols.CVAnnotatable);
    ...
    void acquisitionRunImplementsProtocols() throws Exception {
        ...
        assertTrue(run instanceof global.thalion.ttio.protocols.Indexable);
        assertEquals(2, run.count());
        assertNotNull(run.objectAtIndex(0));

        assertTrue(run instanceof global.thalion.ttio.protocols.Streamable);
        ...
        assertTrue(run instanceof global.thalion.ttio.protocols.Provenanceable);
    ...
    void verifierStatusWrapping() {
        ...
        String sig = global.thalion.ttio.protection.SignatureManager.sign(data, key);
        ...
        assertEquals(global.thalion.ttio.protection.Verifier.Status.INVALID,
            global.thalion.ttio.protection.Verifier.verify(data, sig, wrongKey));
    }

    @Test
    void anonymizationPolicyDefaults() {
        global.thalion.ttio.protection.Anonymizer.AnonymizationPolicy p =
            global.thalion.ttio.protection.Anonymizer.AnonymizationPolicy.defaults();
    ...
    void encryptionRoundTrip() {
        ...
        global.thalion.ttio.protection.EncryptionManager.EncryptResult r =
            global.thalion.ttio.protection.EncryptionManager.encrypt(plaintext, key);
        // decrypt(ciphertext, iv, tag, key)
        byte[] recovered = global.thalion.ttio.protection.EncryptionManager.decrypt(
    ...
    void keyRotationManagerRoundTrip() {
        global.thalion.ttio.protection.KeyRotationManager mgr =
            new global.thalion.ttio.protection.KeyRotationManager();
    ...
    void signatureRoundTrip() {
        ...
        String sig = global.thalion.ttio.protection.SignatureManager.sign(data, key);
        assertTrue(global.thalion.ttio.protection.SignatureManager.verify(data, sig, key));

        byte[] wrongKey = new byte[32];
        java.util.Arrays.fill(wrongKey, (byte) '1');
        assertFalse(global.thalion.ttio.protection.SignatureManager.verify(data, sig, wrongKey));
    }
    ...
    void spectralDatasetHasEncryptableSurface() {
        ...
        assertTrue(global.thalion.ttio.protocols.Encryptable.class
    ...
    void storageProtocolsExposed() {
        global.thalion.ttio.providers.CompoundField cf =
        ...
        assertEquals(global.thalion.ttio.providers.CompoundField.Kind.VL_STRING,
                     cf.kind());

        // Interface types are loadable and have the expected methods.
        assertTrue(global.thalion.ttio.providers.StorageProvider.class.isInterface());
    ...
    void memoryProviderInstantiates() {
        global.thalion.ttio.providers.MemoryProvider p =
            new global.thalion.ttio.providers.MemoryProvider();
        assertNotNull(p);
        assertEquals("memory", p.providerName());
        // Instance satisfies the StorageProvider interface contract.
        assertTrue(p instanceof global.thalion.ttio.providers.StorageProvider);
    }
    ...
    void providerRegistryResolvesMemoryByName() {
        ...
        java.util.Map<String, Class<? extends global.thalion.ttio.providers.StorageProvider>>
            providers = global.thalion.ttio.providers.ProviderRegistry.discover();
        ...
        try (global.thalion.ttio.providers.StorageProvider p =
                global.thalion.ttio.providers.ProviderRegistry.open(
                    url,
                    global.thalion.ttio.providers.StorageProvider.Mode.CREATE,
                    "memory")) {
            assertNotNull(p);
            assertEquals("memory", p.providerName());
        }
        global.thalion.ttio.providers.MemoryProvider.discardStore(url);
    }
    ...
    void cvTermMapperBasicAccessions() {
        ...
        assertEquals(Enums.Precision.FLOAT64,
            global.thalion.ttio.importers.CVTermMapper.precisionFor("MS:1000523"));
        assertEquals(Enums.Precision.FLOAT32,
            global.thalion.ttio.importers.CVTermMapper.precisionFor("MS:1000521"));
        // Unknown accession → FLOAT64 default (matches ObjC and Python).
        assertEquals(Enums.Precision.FLOAT64,
            global.thalion.ttio.importers.CVTermMapper.precisionFor("MS:9999999"),
        ...
        assertTrue(global.thalion.ttio.importers.CVTermMapper.isPrecisionAccession("MS:1000523"));
        assertFalse(global.thalion.ttio.importers.CVTermMapper.isPrecisionAccession("MS:9999999"));
    }
