...
class ProtocolsTest {
    ...
    void encryptableSurface() {
        Set<String> names = methodNames(
            global.thalion.ttio.protocols.Encryptable.class);
    ...
    void indexableSurface() {
        Set<String> names = methodNames(
            global.thalion.ttio.protocols.Indexable.class);
    ...
    void provenanceableSurface() {
        Set<String> names = methodNames(
            global.thalion.ttio.protocols.Provenanceable.class);
    ...
    void streamableSurface() {
        Set<String> names = methodNames(
            global.thalion.ttio.protocols.Streamable.class);
