...
/**
 * SQLite-backed storage provider for MPEG-O.
 *
 * <p>Each MPEG-O file is a single {@code .mpgo.sqlite} SQLite database.
 ...
 * Provider identifier: mpeg_o.providers.sqlite</p>
 *
 ...
 * <ul>
 *   <li>Python: {@code mpeg_o.providers.sqlite.SqliteProvider}</li>
 * </ul>
 *
 * @since 0.6
 */
public final class SqliteProvider implements StorageProvider {
    ...
    public boolean supportsUrl(String pathOrUrl) {
        ...
        return lower.endsWith(".mpgo.sqlite") || lower.endsWith(".sqlite");
    }
    ...
    private void initDb() throws SQLException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(
            ...
            ps.setString(1, "provider"); ps.setString(2, "mpeg_o.providers.sqlite");
            ps.executeUpdate();
        }
        // Root group
        try (PreparedStatement ps = conn.prepareStatement(
