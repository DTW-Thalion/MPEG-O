...
import com.dtwthalion.mpgo.transport.AcquisitionSimulator;
 ...
 * <p>Usage:
 * <pre>
 *   java -cp target/mpgo.jar com.dtwthalion.mpgo.tools.SimulatorCli \
 *        output.mots [--scan-rate 10] [--duration 10] [--ms1-fraction 0.3] \
 *        [--mz-min 100] [--mz-max 2000] [--n-peaks 200] [--seed 42]
 * </pre>
 *
 * <p>Parallel to Python {@code mpeg_o.tools.simulator_cli} and
 * ObjC {@code MpgoSimulator}.</p>
 */
public final class SimulatorCli {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (parsed == null) {
            System.err.println("usage: SimulatorCli <output.mots> "
