...
import com.dtwthalion.mpgo.transport.TransportServer;

/**
 * Command-line transport server. Parallel to Python
 * {@code python -m mpeg_o.tools.transport_server_cli} and ObjC
 * {@code MpgoTransportServer}.
 *
 * <p>Usage:
 * <pre>
 *   java -cp target/classes:/usr/share/java/jarhdf5.jar:&lt;other-deps&gt; \
 *        -Djava.library.path=/usr/lib/x86_64-linux-gnu/jni \
 *        com.dtwthalion.mpgo.tools.TransportServerCli \
 *        input.mpgo [--host 127.0.0.1] [--port 0]
 * </pre>
 *
...
public final class TransportServerCli {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            System.err.println("usage: TransportServerCli <path.mpgo> "
