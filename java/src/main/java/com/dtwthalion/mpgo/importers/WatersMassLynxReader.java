 ...
 * directory and writes mzML, which MPGO parses via
 * {@link MzMLReader}. No Waters proprietary code ships in MPEG-O.</p>
 *
 ...
 * Objective-C: {@code MPGOWatersMassLynxReader} &middot;
 * Python: {@code mpeg_o.importers.waters_masslynx}</p>
 *
 * @since 0.9
 */
public final class WatersMassLynxReader {
    ...
    public static AcquisitionRun read(String dirPath, String converter)
        ...
        Path tmpDir = Files.createTempDirectory("mpgo_masslynx_");
        try {
