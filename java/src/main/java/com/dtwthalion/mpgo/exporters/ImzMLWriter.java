...
import com.dtwthalion.mpgo.importers.ImzMLReader;
import com.dtwthalion.mpgo.importers.ImzMLReader.ImzMLImport;
import com.dtwthalion.mpgo.importers.ImzMLReader.PixelSpectrum;
 ...
 * Python: {@code mpeg_o.exporters.imzml} &middot;
 * Objective-C: {@code MPGOImzMLWriter}</p>
 *
 * @since 0.9
 */
public final class ImzMLWriter {
    ...
    private static String buildXml(
        ...
        sb.append("  <run id=\"mpgo_imzml_export\" defaultInstrumentConfigurationRef=\"IC1\">\n");
