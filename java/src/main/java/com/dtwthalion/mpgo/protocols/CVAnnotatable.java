...
import com.dtwthalion.mpgo.CVParam;
 ...
 * MPEG-O: the schema stays minimal while semantic richness lives in
 * curated external ontologies.
 *
 * <p><b>Cross-language equivalents:</b> Objective-C
 * {@code MPGOCVAnnotatable}, Python
 * {@code mpeg_o.protocols.CVAnnotatable}.</p>
 *
