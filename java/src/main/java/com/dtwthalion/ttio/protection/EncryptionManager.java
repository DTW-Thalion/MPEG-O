...
public final class EncryptionManager {
    ...
    public static void encryptIntensityChannelInRun(String filePath, String runName, byte[] key) {
        try (com.dtwthalion.ttio.hdf5.Hdf5File f =
                     com.dtwthalion.ttio.hdf5.Hdf5File.open(filePath);
             com.dtwthalion.ttio.hdf5.Hdf5Group root = f.rootGroup();
             com.dtwthalion.ttio.hdf5.Hdf5Group study = root.openGroup("study");
             com.dtwthalion.ttio.hdf5.Hdf5Group msRuns = study.openGroup("ms_runs");
             com.dtwthalion.ttio.hdf5.Hdf5Group runGroup = msRuns.openGroup(runName);
             com.dtwthalion.ttio.hdf5.Hdf5Group sig = runGroup.openGroup("signal_channels")) {
            ...
            double[] data;
            try (com.dtwthalion.ttio.hdf5.Hdf5Dataset ds = sig.openDataset("intensity_values")) {
            ...
            try (com.dtwthalion.ttio.hdf5.Hdf5Dataset ds =
                         sig.createDataset("intensity_values_encrypted",
                                 com.dtwthalion.ttio.Enums.Precision.INT32,
    ...
    public static byte[] decryptIntensityChannelInRun(String filePath, String runName, byte[] key) {
        try (com.dtwthalion.ttio.hdf5.Hdf5File f =
                     com.dtwthalion.ttio.hdf5.Hdf5File.openReadOnly(filePath);
             com.dtwthalion.ttio.hdf5.Hdf5Group root = f.rootGroup();
             com.dtwthalion.ttio.hdf5.Hdf5Group study = root.openGroup("study");
             com.dtwthalion.ttio.hdf5.Hdf5Group msRuns = study.openGroup("ms_runs");
             com.dtwthalion.ttio.hdf5.Hdf5Group runGroup = msRuns.openGroup(runName);
            ...
            int[] ivInts;
            try (com.dtwthalion.ttio.hdf5.Hdf5Dataset ds = sig.openDataset("intensity_iv")) {
                ivInts = (int[]) ds.readData();
            }
            int[] tagInts;
            try (com.dtwthalion.ttio.hdf5.Hdf5Dataset ds = sig.openDataset("intensity_tag")) {
     ...
     * file should use
     * {@link com.dtwthalion.ttio.SpectralDataset#decryptInPlace(String, byte[])}.
     *
        ...
        try (com.dtwthalion.ttio.hdf5.Hdf5File f =
            ...
            try (com.dtwthalion.ttio.hdf5.Hdf5Dataset ds =
                         sig.createDataset("intensity_values",
                                 com.dtwthalion.ttio.Enums.Precision.FLOAT64,
