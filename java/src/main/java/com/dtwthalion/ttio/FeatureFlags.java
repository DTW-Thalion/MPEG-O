...
public final class FeatureFlags {
    ...
    public static FeatureFlags readFrom(com.dtwthalion.ttio.providers.StorageGroup root) {
        String version = "1.0.0";
        Set<String> flags = new LinkedHashSet<>();
        if (root.hasAttribute("ttio_format_version")) {
    ...
    public void writeTo(com.dtwthalion.ttio.providers.StorageGroup root) {
