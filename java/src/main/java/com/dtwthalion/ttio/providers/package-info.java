 ...
 * {@link com.dtwthalion.ttio.providers.StorageProvider}) and are
 * resolved by URL scheme or explicit name.
 *
 * Two providers ship with v0.6:
 * <ul>
 *   <li>{@link com.dtwthalion.ttio.providers.Hdf5Provider} — wraps
 *   the existing {@link com.dtwthalion.ttio.hdf5.Hdf5File}.</li>
 *   <li>{@link com.dtwthalion.ttio.providers.MemoryProvider} —
