 ...
 * {@code META-INF/services/com.dtwthalion.ttio.providers.StorageProvider}).
 ...
 * <ul>
 *   <li>Objective-C: {@code TTIOProviderRegistry} (singleton class)</li>
 *   <li>Python: module-level functions in {@code ttio.providers}
