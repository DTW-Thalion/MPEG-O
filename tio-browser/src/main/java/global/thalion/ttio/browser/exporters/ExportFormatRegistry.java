...
public final class ExportFormatRegistry {
    ...
    public static List<ExportFormatSpec> available() {
        return SPECS.stream().filter(ExportFormatSpec::writerOnClasspath).toList();
    }
