...
(:class:`~ttio.SpectralDataset` et al.) must talk to these ABCs and
...
class CompoundFieldKind(Enum):
    ...
    FLOAT64 = "float64"
    VL_STRING = "vl_string"
    # variable-length byte buffer. Used by the per-AU
