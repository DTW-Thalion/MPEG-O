...
class SqliteProvider(StorageProvider):
    ...
    def supports_url(url: str) -> bool:
        ...
        if url.startswith("sqlite://"):
            return True
        lower = url.lower()
        return lower.endswith(".tio.sqlite") or lower.endswith(".sqlite")
