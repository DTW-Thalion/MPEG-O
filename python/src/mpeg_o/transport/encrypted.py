...
``MPGOEncryptedTransport`` · Java
``com.dtwthalion.mpgo.transport.EncryptedTransport``.
"""
...
# ---------------------------------------------------------------------
# Reader side: encrypted stream → new .mpgo file
# ---------------------------------------------------------------------
...
def read_encrypted_to_file(
    ...
    # Emit the .mpgo with encrypted compounds.
