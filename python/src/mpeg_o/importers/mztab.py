...
Mapping into MPEG-O records
---------------------------

| mzTab section | MPEG-O record               | Notes                                                         |
|---------------|------------------------------|---------------------------------------------------------------|
...
class MzTabImport:
    ...
    def to_mpgo(
        ...
        *,
        ...
        """Write the imported records to an .mpgo container.
...
def _resolve_run_name(state: _ParserState, ms_run_index: int) -> str:
    ...
    .mpgo Identification.run_name field. We use the file basename
...
def _build_provenance(state: _ParserState, source: Path) -> ProvenanceRecord | None:
    ...
    return ProvenanceRecord(
        ...
        software="mpeg-o mztab importer v0.9",
        parameters={
