...
Reverses the M59 importer: takes an :class:`mpeg_o.importers.imzml
...
earlier MPGO synthetic tests emitted.

SPDX-License-Identifier: Apache-2.0

Cross-language equivalents
--------------------------
Objective-C: ``MPGOImzMLWriter`` · Java:
``com.dtwthalion.mpgo.exporters.ImzMLWriter``
...
def _build_imzml_xml(
    *,
    ...
    parts: list[str] = [
        ...
        '    <software id="mpeg_o" version="0.9.0">\n',
    ...
    parts += [
        ...
        '    </dataProcessing>\n',
        '  </dataProcessingList>\n',
        '  <run id="mpgo_imzml_export" defaultInstrumentConfigurationRef="IC1">\n',
